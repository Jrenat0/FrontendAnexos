export const ANEXO_FORM_DATA = {
    ...
    curso: [
        { id: 'codigo_curso', label: 'Código del Curso(Listado OTIC)', type: 'text', col: 'col-span-3', 'v': { required: true, maxLength: 30} },
        ...
        { id: 'dir_ejec_curso', label: 'Dirección de Ejecución del curso', type: 'text', col: 'col-span-6', 'v': { required: true, maxLength: 30} },
        ...
        { id: 'tipo_salida_curso', label: 'Tipo de salida', type: 'text', col: 'col-span-3', 'v': { required: true, maxLength: 30} },
